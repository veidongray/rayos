...
qemu: iso
	qemu-system-i386 -m 4G -no-reboot -d int,guest_errors,mmu -D qemu.log -cdrom rayos.iso

qemu-dbg: iso
	qemu-system-i386 -m 4G -S -s -no-reboot -d int,guest_errors,mmu -D qemu.log -cdrom rayos.iso
